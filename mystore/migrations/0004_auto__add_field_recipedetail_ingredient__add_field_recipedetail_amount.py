...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RecipeDetail.ingredient'
        db.add_column('mystore_recipedetail', 'ingredient', self.gf('django.db.models.fields.CharField')(default=0, max_length=255), keep_default=False)

        # Adding field 'RecipeDetail.amount'
        db.add_column('mystore_recipedetail', 'amount', self.gf('django.db.models.fields.CharField')(default=0, max_length=30), keep_default=False)

        # Adding field 'RecipeDetail.cost'
        db.add_column('mystore_recipedetail', 'cost', self.gf('django.db.models.fields.CharField')(default=0, max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RecipeDetail.ingredient'
        db.delete_column('mystore_recipedetail', 'ingredient')

        # Deleting field 'RecipeDetail.amount'
        db.delete_column('mystore_recipedetail', 'amount')

        # Deleting field 'RecipeDetail.cost'
        db.delete_column('mystore_recipedetail', 'cost')
    ...
    models = {
        ...
        'mystore.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 25, 16, 41, 6, 51038)'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'db_index': 'True'}),
