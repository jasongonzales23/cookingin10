...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mystore_purchase', (
            ...
            ('purchased_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('mystore', ['Purchase'])

        # Changing field 'Recipe.slug'
        db.alter_column('mystore_recipe', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))

        # Adding index on 'Recipe', fields ['slug']
        db.create_index('mystore_recipe', ['slug'])

        # Changing field 'Category.slug'
        db.alter_column('mystore_category', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))

        # Adding index on 'Category', fields ['slug']
        db.create_index('mystore_category', ['slug'])


    def backwards(self, orm):
        
        # Removing index on 'Category', fields ['slug']
        db.delete_index('mystore_category', ['slug'])

        # Removing index on 'Recipe', fields ['slug']
        db.delete_index('mystore_recipe', ['slug'])

        # Deleting model 'Purchase'
        db.delete_table('mystore_purchase')

        # Changing field 'Recipe.slug'
        db.alter_column('mystore_recipe', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Category.slug'
        db.alter_column('mystore_category', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'mystore.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 20, 18, 41, 27, 355021)'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'db_index': 'True'}),
